  ...
  render () {
    ...
    return (
      <div id={styles.footer}>
        <div className={`${styles.button} ${styles.home} ${isHome && styles.selected}`}>
          <Link to={homeLink} dangerouslySetInnerHTML={{__html: `
        ...
        <div className={`${styles.button} ${styles.submit} ${isSubmit && styles.selected}`}>
        ...
        <div className={`${styles.button} ${styles.search} ${isSearch && styles.selected}`}>
        ...
        <div className={`${styles.button} ${styles.history} ${isHistory && styles.selected}`}>
